...
export const myProjects = [
  {
    title: 'TokenTrack – Crypto Portfolio Dashboard',
    desc: 'TokenTrack is a modern crypto portfolio dashboard that allows users to track, manage, and analyze their digital assets in real time. With live price updates, interactive charts, and an intuitive interface, it provides a seamless experience for monitoring token performance and portfolio value.',
    subdesc:
  ...
  {
    title: 'TalentVare – Talent Matching Platform',
    desc: 'TalentVare is a modern web platform designed to connect talented professionals with potential opportunities. It provides a clean, intuitive interface for discovering, showcasing, and managing talent efficiently.',
    subdesc:
  ...
  {
    title: 'TravelEase – Camping & Travel Platform',
    desc: 'TravelEase is a visually engaging travel and camping platform that helps users explore destinations, plan trips, and discover outdoor adventures with an elegant, modern interface. It emphasizes user experience through intuitive navigation and immersive design elements.',
    subdesc:
    ...
    logoStyle: {
      ...
      background:
        'linear-gradient(0deg, #718c24, #718c24), linear-gradient(180deg, rgba(255, 255, 255, 0.9) 0%, rgba(208, 213, 221, 0.8) 100%)',
  ...
  {
    title: 'Jawaan Champions – Youth Sports Platform',
    desc: 'Jawaan Champions is a dynamic web platform dedicated to promoting youth sports and community engagement. It offers an energetic, modern interface that highlights events, teams, and achievements in an inspiring and interactive way.',
    subdesc:
...
export const calculateSizes = (isSmall, isMobile, isTablet) => {
  return {
    ...
    reactLogoPosition: isSmall ? [7, 4, 0] : isMobile ? [5, 4, 0] : isTablet ? [5, 4, 0] : [12, 3, 0],
    ringPosition: isSmall ? [-7, 3, 0] : isMobile ? [-10, 10, 0] : isTablet ? [-8, 8, 0]  : [-13, 4, 0],
    targetPosition: isSmall ? [-7, -9, -10] : isMobile ? [-9, -10, -10] : isTablet ? [-11, -7, -10] : [-17, -11, -10],
  };
};
