...
const About = () => {
    const [hasCopied, setHasCopied] = useState(false);
        ...
        const handleCopy = () => {
            navigator.clipboard.writeText('usmanwasif11@outlook.com');
            setHasCopied(true);
  ...
  return (
        ...
        <div className='grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full'>
          ...
          <div className="grid-container">
            <img
              src={`${BASE_PATH}assets/grid4.png`}
              alt="grid-4"
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                <img src={
                  hasCopied
                  ? `${BASE_PATH}assets/tick.svg`
                  : `${BASE_PATH}assets/copy.svg`
                  } 
                alt="copy" />
                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">usmanwasif11@outlook.com</p>
              </div>
            </div>
          </div>
        </div>            
